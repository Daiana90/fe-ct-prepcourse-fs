...
function incrementarPorUno(vector) {
   // El arreglo recibido por parámetro contiene números.
   // Retornar un arreglo con los elementos incrementados en +1.
   // Tu código:

   var len = vector.length;
   var nuevoArreglo = new Array(len);
   for (i=0; i< len; i++) {
      nuevoArreglo[i] = vector[i]+ 1;
   } 
   return nuevoArreglo;
}
...
} else if (arrayResultado.length < 3) {
...
function tablaDelSeis() {
   ...
   // Tu código:
   var multiplicartabladelSeis = [];
   for (var i = 0; i < 11; i ++) {
      multiplicartabladelSeis.push (i * 6);
   }         return       multiplicartabladelSeis;
   }
